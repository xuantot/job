			...
			<div class="login-panel panel panel-default">
                <div class="panel-heading">registration</div>
                                <div class="panel-body">
                                    ...
                                    <form role="form" action="/admin/login/registration" method="POST">
                                        @csrf
                                        <fieldset>
                                            ...
                                            <div class="form-group">
                                                <input class="form-control" placeholder="nhập lại pass" name="password_confirmation" type="password" value="">
                                            </div>

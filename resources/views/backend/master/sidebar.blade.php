<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
    <form role="search">
        ...
        <li><a href="/admin/category"><svg class="glyph stroked clipboard with paper"><use xlink:href="#stroked-clipboard-with-paper" /></svg>Category Jobs</a></li>
        <li><a href="/admin/company"><svg class="glyph stroked clipboard with paper"><use xlink:href="#stroked-clipboard-with-paper" /></svg>Company</a></li>
        <li><a href="/admin/job"><svg class="glyph stroked notepad "><use xlink:href="#stroked-notepad" /></svg> Jobs</a></li>

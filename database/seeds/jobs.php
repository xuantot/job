...
class jobs extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('jobs')->insert([ 
            ...
            ['id'=>2, 'job_code'=>"SP02", 'job_name'=>"Kĩ sư Web", 'salary'=>"350000000", 'experience'=>"2 năm", 'nature'=>"full time", 'info_job'=>"", 'logo'=>"2.svg", 'status'=>1, "category_id"=>"2", 'company_id'=>"2"],
            ...
            ['id'=>4, 'job_code'=>"SP04", 'job_name'=>"Giáo viên tin học", 'salary'=>"350000000", 'experience'=>"2 năm", 'nature'=>"part time", 'info_job'=>"", 'logo'=>"4.svg", 'status'=>1, "category_id"=>"4", 'company_id'=>"1"],
